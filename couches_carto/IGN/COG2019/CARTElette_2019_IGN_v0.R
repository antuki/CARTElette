...
url <- "ftp://Admin_Express_ext:Dahnoh0eigheeFok@ftp3.ign.fr/ADMIN-EXPRESS-COG_2-0__SHP_L93__FRA_2019-05-20.7z.001"


dest <- "ADMIN-EXPRESS-COG_2-0__SHP_L93__FRA_2019-05-20.7z"
######################################################################
...
fr_metro <- st_read("./source/ADMIN-EXPRESS-COG_2-0__SHP__FRA_2019-05-20/ADMIN-EXPRESS-COG/1_DONNEES_LIVRAISON_2019-05-20/ADE-COG_2-0_SHP_LAMB93_FR/COMMUNE_CARTO.shp",
                    stringsAsFactors = F) %>%
  st_transform(4326) %>%  as('Spatial') 

fr_971 <- st_read("./source/ADMIN-EXPRESS-COG_2-0__SHP__FRA_2019-05-20/ADMIN-EXPRESS-COG/1_DONNEES_LIVRAISON_2019-05-20/ADE-COG_2-0_SHP_RGAF09UTM20_D971/COMMUNE_CARTO.shp",
                  stringsAsFactors = F)%>%
  st_transform(4326) %>% as('Spatial') %>% 
...
fr_972 <- st_read("./source/ADMIN-EXPRESS-COG_2-0__SHP__FRA_2019-05-20/ADMIN-EXPRESS-COG/1_DONNEES_LIVRAISON_2019-05-20/ADE-COG_2-0_SHP_RGAF09UTM20_D972/COMMUNE_CARTO.shp",stringsAsFactors = F)%>%
  st_transform(4326) %>% as('Spatial') %>% 
  transformation_shp(rot=0, scale=1, shift=c(0,41)) 
proj4string(fr_972) <- proj4string(fr_metro)

fr_973 <- st_read("./source/ADMIN-EXPRESS-COG_2-0__SHP__FRA_2019-05-20/ADMIN-EXPRESS-COG/1_DONNEES_LIVRAISON_2019-05-20/ADE-COG_2-0_SHP_UTM22RGFG95_D973/COMMUNE_CARTO.shp",stringsAsFactors = F) %>%
  st_transform(4326) %>% as('Spatial') %>% 
  transformation_shp(rot=0, scale=1, shift=c(2,41)) 
proj4string(fr_973) <- proj4string(fr_metro)

fr_974 <- st_read("./source/ADMIN-EXPRESS-COG_2-0__SHP__FRA_2019-05-20/ADMIN-EXPRESS-COG/1_DONNEES_LIVRAISON_2019-05-20/ADE-COG_2-0_SHP_RGR92UTM40S_D974/COMMUNE_CARTO.shp",stringsAsFactors = F) %>%
  st_transform(4326) %>% as('Spatial') %>% 
  transformation_shp(rot=0, scale=1, shift=c(4,41)) 
proj4string(fr_974) <- proj4string(fr_metro)

fr_976 <- st_read("./source/ADMIN-EXPRESS-COG_2-0__SHP__FRA_2019-05-20/ADMIN-EXPRESS-COG/1_DONNEES_LIVRAISON_2019-05-20/ADE-COG_2-0_SHP_RGM04UTM38S_D976/COMMUNE.shp",stringsAsFactors = F) %>%
  st_transform(4326) %>% as('Spatial') %>% 
