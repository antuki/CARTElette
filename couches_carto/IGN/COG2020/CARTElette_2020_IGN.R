...
# paramètres
annee <- "2020"
# Fichier : AdminExpress 2020
url <- "ftp://Admin_Express_ext:Dahnoh0eigheeFok@ftp3.ign.fr/ADMIN-EXPRESS-COG_2-1__SHP__FRA_WGS84G_2020-11-20.7z"


dest <- "ADMIN-EXPRESS-COG_2-1__SHP__FRA_WGS84G_2020-11-20.7z"
######################################################################
...
#fr_initial <- st_read("../sources_shp/data_IGN/COG2020/source/ADMIN-EXPRESS-COG_2-0__SHP__FRA_2019-09-24/ADMIN-EXPRESS-COG/1_DONNEES_LIVRAISON_2019-09-24/ADE-COG_2-0_SHP_WGS84_FR/COMMUNE_CARTO.shp", stringsAsFactors = F)
fr_initial <- st_read("../sources_shp/data_IGN/COG2020/ADMIN-EXPRESS-COG_2-1__SHP__FRA_2020-11-20/ADMIN-EXPRESS-COG/1_DONNEES_LIVRAISON_2020-11-20/ADE-COG_2-1_SHP_WGS84G_FRA/COMMUNE_CARTO.shp", stringsAsFactors = F)
