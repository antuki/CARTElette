...
fr_initial <- st_read("../sources_shp/data_IGN/COG2023/ADMIN-EXPRESS-COG-CARTO_3-2__SHP_WGS84G_FRA_2023-05-03/ADMIN-EXPRESS-COG-CARTO/1_DONNEES_LIVRAISON_2023-05-03/ADECOGC_3-2_SHP_WGS84G_FRA/COMMUNE.shp", stringsAsFactors = F)
...
liste_mailles <- c("DEP","EPCI","ARR" ,"CV","ZE2020","UU2020","AAV2020","BV2022","REG")
